...
Config.CustomAIPlates            = "MAIDGOUZ" -- Custom plates for AI vehicles
...
Config.ExoIDAPPlication =  870859434094641213

Config.PlayerCount = 4

Config.PlayerText = "Joueurs" -- Player text. Example Players 10/32

Config.ResourceTimer = 5 -- Time in witch resource updates in seconds
...
Config.Buttons = { -- Your buttons
    ...
    {index = 0,name = 'Discord',url = 'https://discord.gg/xwqBYwP7S8'},

    {index = 1,name = 'Connexion',url = 'fivem://connect/'}
