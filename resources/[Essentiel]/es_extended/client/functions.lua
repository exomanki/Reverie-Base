...
function ESX.GetVehicleType(model)
    ...
    return types[vehicleType] or "automobile"
      ...
      function SetData()
        ...
        Citizen.InvokeNative(GetHashKey("ADD_TEXT_ENTRY"), 'FE_THDR_GTAO', "~r~Exo~w~ RP~s~ | Discord : https://discord.gg/tpw3bE6aDK  ~g~~s~ | ID: "..id.." | ~r~".. #players .." connecté(e)s")
    ...
    Citizen.CreateThread(function()
        ...
        AddTextEntry("PM_PANE_LEAVE", "~r~Se déconnecter de ~p~Exo~w~ RP 😭")
...
AddEventHandler('Boost-Discord:SetPresence', function(data)
	...
	SetDiscordAppId(Config.ExoIDAPPlication)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		TriggerServerEvent('Exolpb:UpdatePresence')
